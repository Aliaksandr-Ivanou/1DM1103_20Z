...
{
    printf("step 1:\n");
    char *url = argc < 2 ? "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/reset/qwerty_9" : argv[1];
    make_request(url);
    printf("step 2:\n");
    url = argc < 2 ? "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/info/qwerty_9" : argv[1];
    make_request(url);
    printf("step 3:\n");
    url = argc < 2 ? "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/qwerty_9/left" : argv[1];
    make_request(url);
    printf("step 4:\n");
    url = argc < 2 ? "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/qwerty_9/left" : argv[1];
    make_request(url);
    printf("step 5:\n");
    url = argc < 2 ? "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/explore/qwerty_9" : argv[1];
    make_request(url);
    printf("step 6:\n");
    url = argc < 2 ? "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/move/qwerty_9" : argv[1];
    make_request(url);
    return 0;
}